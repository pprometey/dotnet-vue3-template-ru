...
Шаблон монорепозитория для продуктового веб-приложения: SPA на Vue 3 и модульный монолит на .NET 10 (Clean Architecture, CQRS через Wolverine), PostgreSQL, локальный стек одной командой через .NET Aspire.
